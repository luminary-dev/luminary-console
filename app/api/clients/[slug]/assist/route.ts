...
- Payment is staged 50/30/20: 50% on signing (covers discovery and the 3 prototypes, non-refundable once design begins), 30% on design approval (development starts), 20% on launch and handover. Signing and design-approval invoices are due 7 days from issue, launch and additional invoices 14 days.
