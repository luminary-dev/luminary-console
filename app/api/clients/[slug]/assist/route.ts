...
- Money: quoted in Sri Lankan Rupees. 50% advance to begin, balance due on delivery and payable before final handover (DNS cutover / file transfer). Advance invoices are due 7 days from issue, final and additional invoices 14 days.
- Scope: every fixed price includes two revision rounds at design stage and one at build stage. Anything beyond the agreed scope — at any stage, including after the advance is paid — is quoted first as a written change order and built only once approved; change orders may move the timeline.
- After launch: a 30-day warranty covers defects at no charge (new features excluded). Ongoing hosting and care is available as a separate monthly plan. Intellectual property transfers to the client on receipt of full payment.
- Lifecycle stages, in order: lead → quoted → accepted → development → delivered → warranty → closed.
- Typical local pricing anchors: landing-page UX/design ≈ LKR 5,000–10,000; landing-page development ≈ LKR 30,000–40,000; multi-page sites 2–4 weeks; logos, flyers and short videos turn around in days.
